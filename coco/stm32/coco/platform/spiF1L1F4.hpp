...
/*
    Defines:
    HAVE_SPI_DATA_16          Support for 16 data bits
    HAVE_SPI_DATA_4_16        Support for 4 to 16 data bits (is not supported)
...
#ifdef HAVE_SPI_DATA_16
    | SPI_CR1_DFF
#endif
    ;
constexpr int FORMAT_CR2_MASK = SPI_CR2_FRF;
...
enum class Status : uint32_t {
    ...
    ALL = RX | TX | BUSY | OVERRUN | UNDERRUN | CRC_ERROR
};
COCO_ENUM(Status)
...
#ifdef HAVE_SPI_DATA_16
        spi->CR1 = (spi->CR1 & ~SPI_CR1_DFF) | (CR1(format) & SPI_CR1_DFF);
#endif
        return *this;
    }
