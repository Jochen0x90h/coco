...
// basic timers
static const BasicInfo TIM6_INFO{TIM6, {&RCC->APB1ENR, RCC_APB1ENR_TIM6EN}, {TIM6_DAC1_IRQn}};
#ifdef TIM7
static const BasicInfo TIM7_INFO{TIM7, {&RCC->APB1ENR, RCC_APB1ENR_TIM7EN}, {TIM7_DAC2_IRQn}};
#endif
...
#ifdef TIM19
static const FullGpInfo TIM19_INFO{TIM19, {&RCC->APB2ENR, RCC_APB2ENR_TIM19EN}, {TIM19_IRQn}};
#endif

// advanced control timers
#ifdef TIM1
static const AcInfo TIM1_INFO{TIM1, {&RCC->APB2ENR, RCC_APB2ENR_TIM1EN}, {TIM1_BRK_TIM15_IRQn, TIM1_UP_TIM16_IRQn, TIM1_TRG_COM_TIM17_IRQn, TIM1_CC_IRQn}};
#endif
#ifdef TIM8
...
#endif
#ifdef TIM20
static const AcInfo TIM20_INFO{TIM20, {&RCC->APB2ENR, RCC_APB2ENR_TIM20EN}, {TIM20_BRK_IRQn, TIM20_UP_IRQn, TIM20_TRG_COM_IRQn, TIM20_CC_IRQn}};
#endif
