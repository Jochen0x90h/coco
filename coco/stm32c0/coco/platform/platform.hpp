...
#include <coco/platform/stm32c0.h> // select device header (generated by CMake)
...
constexpr uint32_t RCC_CR_HSIKERDIV_DIV1 = 0;
constexpr uint32_t RCC_CR_HSIKERDIV_DIV2 = RCC_CR_HSIKERDIV_0;
constexpr uint32_t RCC_CR_HSIKERDIV_DIV4 = RCC_CR_HSIKERDIV_1; // reset value
constexpr uint32_t RCC_CR_HSIKERDIV_DIV8 = RCC_CR_HSIKERDIV_1 | RCC_CR_HSIKERDIV_0;
constexpr uint32_t RCC_CR_HSIKERDIV_DIV16 = RCC_CR_HSIKERDIV_2;
constexpr uint32_t RCC_CR_HSIKERDIV_DIV32 = RCC_CR_HSIKERDIV_2 | RCC_CR_HSIKERDIV_0;
constexpr uint32_t RCC_CR_HSIKERDIV_DIV64 = RCC_CR_HSIKERDIV_2 | RCC_CR_HSIKERDIV_1;
constexpr uint32_t RCC_CR_HSIKERDIV_DIV128 = RCC_CR_HSIKERDIV_2 | RCC_CR_HSIKERDIV_1 | RCC_CR_HSIKERDIV_0;
