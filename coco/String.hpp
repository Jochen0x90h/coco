...
public:
    ...
    /**
     * Construct from container supporting std::data() and std::size() with compatible data type (e.g. coco::Array, std::string)
     */
    ...
    /**
     * Return the index of the first occurrence of a character or a default value (-1) when not found
    ...
    /**
     * Return the index of the first occurrence of a string or a default value (-1) when not found
