...
/// @brief ADC clock configuration (CFGR2 and CCR registers)
...
/// @brief ADC trigger
/// Reference manual section 15.3.1, Table 73
enum class Trigger : uint32_t {
    ...
    ADC1_TIM6_TRGO = ADC_CFGR1_EXTEN_0 | (5 << ADC_CFGR1_EXTSEL_Pos),
#ifdef TIM4
    ADC1_TIM4_TRGO = ADC_CFGR1_EXTEN_0 | (6 << ADC_CFGR1_EXTSEL_Pos),
#endif
...
static const Info ADC1_INFO{ADC1_COMMON, ADC1, RCC_APBENR2_ADCEN, ADC1_COMP_IRQn, 5};
